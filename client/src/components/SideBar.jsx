...
const SideBar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    <div className={`flex flex-col h-screen min-w-72 p-5 dark:bg-gradient-to-b from-[#242124]/30 to-[#000000]/30 border-r border-[#80609F]/30 backdrop-blur-3xl transition-all duration-500 max-md:absolute left-0 z-1 ${!isMenuOpen && 'max-md:-translate-x-full'}`}>
      ...
      {/* {New Chat Button} */}
      <button className="flex items-center gap-2 w-full bg-gradient-to-r from-[#E6CCFF] to-[#80609F] text-[#380038] px-5 py-3 rounded-full font-medium mt-6 hover:opacity-90 transition-all duration-500">
        <span className="text-xl">+</span> New Chat
      </button>

      {/* {Search Conversations} */}
      <div className="flex items-center gap-2 p-3 mt-4 border border-gray-400 dark:border-white/20 rounded-full">
